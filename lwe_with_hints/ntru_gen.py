...
from sympy import symbols, Poly, div, floor
import math
...
class NTRUKeyGenerator:
  ...
  """
    ...
    def polynomialEEA_mod2(self, f_1, f_2):
        ...
        if f_1 == zeroPoly:
            ...
            return (
                self.sympyPolyCoeffMod2(g),
                self.sympyPolyCoeffMod2(t - q * s),
                self.sympyPolyCoeffMod2(s),
            )
  ...
  """
    ...
    def S2_inverse(self, poly):
        g, s, t = self.polynomialEEA_mod2(
            self.polyToSympy(poly), self.polyToSympy(self.phi_n)
        )
